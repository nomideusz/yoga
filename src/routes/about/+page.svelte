...
<svelte:head>
  ...
  <title>O projekcie | szkolyjogi.pl</title>
  <meta
    name="description"
    content="szkolyjogi.pl to katalog szkół jogi w Polsce — porównuj ceny, style i lokalizacje w jednym miejscu."
  />
  <meta property="og:title" content="O projekcie | szkolyjogi.pl" />
  <meta
